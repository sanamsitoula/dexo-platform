...
echo ""
echo "  Tenant switching (dev, single-tenant-per-instance mode):"
echo "    DEV_TENANT=spicegarden npm run dev --workspace=@dexo/tenant-website"
echo ""
echo "========================================"
echo ""
...
if command -v xdg-open &> /dev/null; then
  for url in http://localhost:3001 http://localhost:3002 http://localhost:4005 http://localhost:4006 http://localhost:4007 http://localhost:4000/api/docs; do
