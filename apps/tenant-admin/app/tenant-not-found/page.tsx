 ...
 * any tenant — no silent 'vrfitness' default anymore, this is a real error state. */
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md w-full rounded-xl border border-gray-200 bg-white p-8 text-center shadow-sm">
        ...
        <div className="mt-5 text-left text-sm bg-gray-50 rounded-lg p-4 space-y-1 text-gray-600">
          <p className="font-medium text-gray-800">To open a specific business&apos;s admin:</p>
          <p>Use its full link, e.g. <code className="text-xs">admin.&lt;business&gt;.localhost:4006</code></p>
