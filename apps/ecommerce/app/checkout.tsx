    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ padding: Spacing.lg, paddingBottom: Spacing.xxl }}>
        ...
        <View style={styles.paymentRow}>
          {/* Online prepayment (eSewa/Fonepay/ConnectIPS/Stripe/PayPal) needs a
              browser/webview redirect to the gateway, which this app doesn't
              have a dependency for yet — offering PREPAID here would place an
              order that's never actually confirmed as paid. COD-only until a
              webview-based gateway flow ships (tracked as a follow-up). */}
          <TouchableOpacity
            style={[styles.paymentOption, { borderColor: primary, backgroundColor: primary + '10' }]}
            disabled
          >
            <Ionicons name="cash-outline" size={20} color={primary} />
            <Text style={[styles.paymentText, { color: primary }]}>Cash on delivery</Text>
          </TouchableOpacity>
        </View>
